...
dp.plotter(clean_abd_data, c("time"), "rli", "gek_num", "Light intensity of quadrat relative to ambient", "Gecko abundance in quadrat", c(0,50), c(0,10), "Gecko abundance separated by")
```
