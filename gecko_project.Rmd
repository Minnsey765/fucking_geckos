...
dp.boxplot(smooshed_data, "length_cm", "quad_type","Comparison of size between geckos in different quadrats", "Quadrat type experimental or control", "Gecko")
...
dp.boxplot(unfltr_smooshed_data, "length_cm", "quad_type","Comparison of size between geckos in different quadrats", "Quadrat type experimental or control", "Gecko")
...
dp.boxplot(outrm_smooshed_data, "length_cm", "quad_type","Comparison of size between geckos in different quadrats", "Quadrat type experimental or control", "Gecko")
...
```{r}
#plot for filtered outliar_removed data
dp.boxplot(outrm_unfltr_smooshed_data, "length_cm", "quad_type","Comparison of size between geckos in different quadrats", "Quadrat type experimental or control", "Gecko")
